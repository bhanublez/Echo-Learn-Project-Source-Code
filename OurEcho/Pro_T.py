...
def getTrainer(language: str):
    ...
    model.eval()
    asr_model = AI_mdls.NeuralASR(model, decoder)

    if language == 'en':
        phonem_converter = Model_Ru.EngPhonemConverter()
    else:
...
class PronunciationTrainer:
    ...
    def getPronunciationAccuracy(self, real_and_transcribed_words_ipa) -> float:
        ...
        for pair in real_and_transcribed_words_ipa:
            ...
            number_of_word_mismatches = Matrix_W.edit_distance_python(
